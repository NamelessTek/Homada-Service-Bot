        ...
        if 'question_id' in session:
            ...
            match question_id:
                ...
                case 7:
                    ...
                    ubicacion_query= Ubicacion.query.filter_by(ubicacion=session['ubicacion_cliente']).first()
...
def goodbye_twiml():
    mensaje = "Ya quedo creada la reservación "+ session['num_reservacion_cliente']+ " :)"
    delete_session()
    return mensaje
